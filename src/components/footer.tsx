        ...
        <div className="grid md:grid-cols-3 gap-12">
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="text-gray-500 hover:text-blue-700 dark:hover:text-blue-300 text-sm transition-colors"
                >
                  LinkedIn
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="https://wa.me/6282244731648"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 text-gray-500 hover:text-green-600 text-sm transition-colors"
                >
                  <WhatsAppIcon />
                  +62 822-4473-1648
                </a>
              ...
              <li>
                <a
                  href="https://wa.me/6281217393815"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 text-gray-500 hover:text-green-600 text-sm transition-colors"
                >
              ...
              <li className="flex items-center gap-3 text-gray-500 text-sm">
                <a href={`mailto:${EMAIL}`} className="flex items-center gap-3 hover:text-blue-300 transition-colors">
                  <EmailIcon />
                  {EMAIL}
                </a>
              </li>
