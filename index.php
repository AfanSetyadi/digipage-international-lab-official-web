                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-6">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <div class="text-gray-500 text-sm mt-1">Telah menjangkau project dan prestasi di lebih dari 5 negara</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="relative rounded-3xl bg-gradient-to-br from-brand-100 via-brand-50 to-transparent dark:from-brand-600/20 dark:via-brand-800/10 dark:to-transparent border border-gray-200 dark:border-white/5 overflow-hidden">
            ...
            <div class="relative px-8 py-16 sm:px-16 sm:py-24 text-center">
                ...
                <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="mailto:digitallandingteknologi@gmail.com" class="inline-flex items-center justify-center gap-3 px-8 py-4 bg-brand-600 hover:bg-brand-700 text-white font-semibold rounded-xl transition-all hover:shadow-lg hover:shadow-brand-600/25">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                        digitallandingteknologi@gmail.com
                    </a>
